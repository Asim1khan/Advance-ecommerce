...
<div class="body-content outer-top-xs" id="top-banner-and-menu">
            ...
            <nav class="yamm megamenu-horizontal">
              <ul class="nav">
                ...
                <li class="dropdown menu-item"> <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                    <i class="icon {{$categorie->catagory_icon}}" aria-hidden="true"></i>
                    @if (session()->get('language')=='urdu'){{ $categorie->catagory_name_urdu }}
                        @else
                        {{ $categorie->catagory_name_eng }}
                    @endif
                    </a>
                  <ul class="dropdown-menu mega-menu">
                    <li class="yamm-content">
                      <div class="row">
                          @php
                              $subcategories=App\Models\SubCatagory::where('catagory_id',$categorie->id)->orderBy('sub_catagory_name_eng','ASC')->get();
                          @endphp
                          @foreach ($subcategories as $subcatagorie)

                        <div class="col-sm-12 col-md-3">
                            <h2 class="title">
                                @if (session()->get('language')=='urdu'){{ $subcatagorie->sub_catagory_name_urdu }}</h2>

                                    @else{{ $subcatagorie ->sub_catagory_name_eng }}
                                @endif</h2>
                              @php
                                  $subsubcategore=App\Models\SubSubCatagory::where('subcatagory_id',$subcatagorie->id)->orderBy('subsubcatagory_name_eng')->get();
                              @endphp
                          <ul class="links list-unstyled">

                              @foreach ( $subsubcategore as $subsubcategorie)
                            <li><a href="#">
                                @if(session()->get('language')=='urdu') {{ $subsubcategorie ->subsubcatagory_name_urdu }}
                                @else {{ $subsubcategorie ->subsubcatagory_name_eng }}
            ...
            <div class="more-info-tab clearfix ">
              ...
              <ul class="nav nav-tabs nav-tab-line pull-right" id="new-products-1">
                ...
                <li class="active"><a data-transition-type="backSlide" href="#all" data-toggle="tab">All</a></li>
                   <!-- categorie name  loop start-->
                @foreach ($categories as $categorie)

                <li><a data-transition-type="backSlide" href=" #categorie{{ $categorie->id }}" data-toggle="tab">
                  {{$categorie->catagory_name_eng  }}</a></li>
                @endforeach
             <!-- end of categorie tab foreach loop-->
              ...
              <div class="tab-pane in active" id="all">
                <div class="product-slider">
                  <div class="owl-carousel home-owl-carousel custom-carousel owl-theme" data-item="4">
                          ...
                          <div class="product-info text-left">
                            ...
                            <div class="description"></div>
                             <div class="product-price">
                                     ...
                                     <span class="price-before-discount">{{ round($discount) }}</span> </div>
                                      @endif
                    ...
                    <!-- /.item -->
                    @endforeach   <!--end for each of the product picture-->
    ...
    <!-- for product select by the base of categorywise -->
       @foreach($categories as $categorie)
              ...
              <div class="tab-pane" id="categorie{{ $categorie->id }}">
                <div class="product-slider">
                  <div class="owl-carousel home-owl-carousel custom-carousel owl-theme" data-item="4">
                    ...
                    @php
                    // to check the status of the product is active or not active it will display
                        $catawiseproduct=App\Models\Product::where('status',1)->where('category_id',$categorie->id)->orderBy('id','DESC')->get();
                    @endphp
                    <!--for each of item picture-->
                    @forelse($catawiseproduct as $product )
                        ...
                        <div class="products">
                          <div class="product">
                            ...
                            <div class="product-info text-left">
                              <h3 class="name">
                                        @if (session()->get('language')=='urdu')
                                        <a href="detail.html">{{ $product->product_name_urdu }}</a>

                                           @else
                                           <a href="detail.html">{{ $product->product_name_eng }}</a>
                    ...
                    @endforelse  <!--end for each of the product option-->
              ...
              @endforeach
                 <!-- end foreach of categories table-->
              <!-- /.tab-pane -->
